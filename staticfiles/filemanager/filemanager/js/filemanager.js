...
(function() {
    ...
    // Extension → compatible app list
    const APP_EXTENSIONS = {
        reader:      new Set(['pdf','jpg','jpeg','png','tiff','tif','webp','bmp']),
        anonymizer:  new Set(['mp4','webm','mkv','avi','mov','jpg','jpeg','png','webp','gif','bmp']),
        transcriber: new Set(['mp3','wav','flac','ogg','m4a','aac','opus','wma','mp4','webm','mkv','avi','mov']),
        describer:   new Set(['jpg','jpeg','png','webp','gif','bmp','mp4','webm','mov','avi','mkv']),
        enhancer:    new Set(['jpg','jpeg','png','webp','bmp','tif','tiff','mp4','webm','mkv','avi','mov','mp3','wav','flac','ogg','m4a','aac']),
        synthesizer: new Set(['txt','csv']),
    };

    const APP_LABELS = {
        reader:      { icon: 'fa fa-book-open', label: 'Reader (OCR)' },
        anonymizer:  { icon: 'fa fa-user-secret', label: 'Anonymizer' },
        transcriber: { icon: 'fa fa-microphone', label: 'Transcriber' },
        describer:   { icon: 'fa fa-eye', label: 'Describer' },
        enhancer:    { icon: 'fa fa-magic', label: 'Enhancer' },
        synthesizer: { icon: 'fa fa-volume-up', label: 'Synthesizer' },
    };
