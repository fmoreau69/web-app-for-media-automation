...
| **File d'attente (front)** | Comportements communs des files : collapse de batch persisté, mode Solitaire (accordéon), toggle Ligne/Mosaïque, les 3 densités et le modificateur PILE (CARD_DESIGN §11.4/§11.9), focus card, clearCards, data-wama-* | `wama/common/static/common/js/wama-queue.js` | `CARD_DESIGN.md` | 98 |
...
**Mécanismes déclarés : 129** · domiciles absents : 0 · sans consommateur : 2 · assumés locaux : 17 · modules balayés non rattachés : 42 · **de niveau app sans critère de grille : 37**
