    ...
    async function deleteAsset(id, card) {
        ...
        try {
            ...
            if (resp.ok && data.deleted) {
                ...
                // Si la grille est vide après suppression, recharger pour afficher le message "vide"
    ...
    confirmBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            if (resp.ok && data.id) {
                ...
                resetUploadForm();
                // Ajouter la carte en tête de grille (avant les assets système)
                ...
                // Retirer le message "vide" s'il était affiché
