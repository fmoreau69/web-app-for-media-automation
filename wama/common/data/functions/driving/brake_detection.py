"""
Détection de freinage brusque — portage SALSA (`ComputeAccClean` + `identifyBrakeSignal`
...
⚠️ Les seuils de SALSA n'étaient PAS dans les .m (dans le modèle compilé) : les défauts
