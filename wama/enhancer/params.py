...
# name = clé POST (update_settings) ET data-attr de la card (data-ai-model…) ; dom_id.panel = id du champ.
MEDIA_PARAMS = [
    Param(name='ai_model', type='select', label='Modèle AI', icon='fa-brain',
          dom_id={'panel': 'defaultAiModel'}, contexts=('panel', 'item'),
    ...
    Param(name='denoise', type='toggle', label='Débruitage', icon='fa-broom',
          dom_id={'panel': 'defaultDenoise'}, contexts=('panel', 'item'),
          help_fallback='Applique un débruitage avant l\'upscaling.'),
    Param(name='blend_factor', type='range', label='Blend', icon='fa-sliders-h',
          dom_id={'panel': 'defaultBlendFactor'}, min=0, max=1, step=0.1, contexts=('panel', 'item'),
...
AUDIO_PARAMS = [
    Param(name='engine', type='select', label='Moteur', icon='fa-cogs',
          dom_id={'panel': 'audioEngine'}, contexts=('panel', 'item'),
    ...
    Param(name='mode', type='select', label='Mode', icon='fa-sliders-h',
          dom_id={'panel': 'audioMode'}, contexts=('panel', 'item'),
    ...
    Param(name='strength', type='range', label='Force', icon='fa-wind',
          dom_id={'panel': 'audioDenoisingStrength'}, min=0, max=1, step=0.1, contexts=('panel', 'item'),
          help_fallback='Intensité du débruitage.'),
    Param(name='quality', type='select', label='Qualité (NFE)', icon='fa-star',
          dom_id={'panel': 'audioQuality'}, contexts=('panel', 'item'),
